...
_(Если у вас не устанавливается на этой верссии "Reactor" - обращайтесь к автору этого расширения т.к. он не встает и на оригинальном портабельном ComfyUI. Reactor, очевидно, требует 3.10 версию питона, и прекрано встает на нашей <a href=https://github.com/ComfyUI-RUS/ComfyUI-RUS>**"НЕ-портабельной"**</a> версии)_
---
